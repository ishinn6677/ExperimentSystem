...
public interface IAppointDao {
    ...
    List<Appoint> isExistOfAppointByTimeAndStuId(@Param("weekth")int weekth,@Param("dayth")int dayth,@Param("courseth")int courseth, @Param("stu_id")String stu_id);//根据时间和学生id看是否存在
}
